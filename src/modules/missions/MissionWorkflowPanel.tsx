...
export function MissionWorkflowPanel({ mission, organisationId }: Props) {
  ...
  const executer = useExecuterTransitionMission(mission.id);
  ...
  return (
    <Card title="Circuit de la mission" style={{ marginTop: 16 }}>
      ...
      <Space style={{ marginBottom: 16 }} wrap>
        ...
        {instance?.statut_instance !== 'en_cours' && (
          <Typography.Text type="secondary">Mission clôturée.</Typography.Text>
        )}
