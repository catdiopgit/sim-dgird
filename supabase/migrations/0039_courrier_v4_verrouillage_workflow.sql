-- Complète le verrouillage (V4 §11: "les API/services et toutes les
-- opérations d'écriture doivent également vérifier que le courrier est
-- verrouillé") : les policies RLS (0037/0038) couvrent les écritures
-- directes sur courriers/courrier_destinataires/courrier_pieces_jointes,
-- mais fn_executer_transition_courrier et fn_imputer_courrier passent par
-- des fonctions SECURITY DEFINER qui contournent RLS — il faut donc vérifier
-- explicitement le verrou dans ces deux fonctions également.
